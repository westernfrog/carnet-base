      ...
      {props.sender == true ? (
        ...
        <div className="flex items-end gap-2">
          <Image
            ...
            height={50}
            alt="Profile Picture"
            className="w-8 h-8 object-cover object-center rounded-full ring-2 ring-violet-950/90 flex-shrink-0"
          />
          <div className="flex flex-col gap-2">
            <div className="relative p-5 rounded-2xl bg-violet-950/10 shadow-inner lg:max-w-xl max-w-sm">
              <h1 className="tracking-normal lg:text-base text-sm">
                {props.message}
              </h1>
